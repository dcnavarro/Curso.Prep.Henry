...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí
//Should return the name of the day associated with that number
}
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
//should return true or false in case the received number starts with nine
}
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí
//Should return true if all the elements of the array are equal and false otherwise
}
...
function mesesDelAño(array) {
  ...
  // Tu código:
  // should return a new array with the requested months
}
...
function mayorACien(array) {
  ...
  // Tu código:
  //should return an array with the values resulting from adding 2 in each iteration
}
...
function breakStatement(numero) {
  ...
  // Tu código:
  //should return an array with the values resulting from adding 2 in each iteration
//should stop the execution if the sum value and the iteration number match
}
